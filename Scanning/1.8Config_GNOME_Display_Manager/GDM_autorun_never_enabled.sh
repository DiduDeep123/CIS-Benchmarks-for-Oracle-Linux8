...
log_message "Checking GDM autorun-never is enabled..."
 ...
 if [ -z "$l_output2" ]; then
 echo -e "\n- Audit Result:\n ** PASS **\n$l_output\n"
 echo "GDM AUTORUN-NEVER:ENABLED" >> $RESULT_FILE
 log_message "GDM autorun never is enabled."
 else
 echo -e "\n- Audit Result:\n ** FAIL **\n - Reason(s) for audit failure:\n$l_output2\n"
 [ -n "$l_output" ] && echo -e "\n- Correctly set:\n$l_output\n"
 echo "GDM AUTORUN-NEVER:DISABLED" >> $RESULT_FILE
 log_message "GDM autorun-never is disabled."
 fi
