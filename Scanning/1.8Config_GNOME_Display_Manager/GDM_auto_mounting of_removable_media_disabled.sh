...
log_message "Checking if GDM automatic mounting of removable media is disabled..."
...
# check automount setting
 ...
 if [ -z "$l_output2" ]; then
 echo -e "\n- Audit Result:\n ** PASS **\n$l_output\n"
 echo "AUTOMATIC MOUNTING OF REMOVABLE MEDIA:DISABLED" >> $RESULT_FILE
 log_message "GDM automatic mounting of removable media is disabled."
 else
 echo -e "\n- Audit Result:\n ** FAIL **\n - Reason(s) for audit failure:\n$l_output2\n"
 [ -n "$l_output" ] && echo -e "\n- Correctly set:\n$l_output\n"
 echo "AUTOMATIC MOUNTING OF REMOVABLE MEDIA:NOT DISABLED" >> $RESULT_FILE
 log_message "GDM automatic mounting of removable media is not disabled or GDM is not installed."
 fi
