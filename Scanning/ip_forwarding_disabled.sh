...
log_message "Checking if ip forwarding is disabled..."
 l_output="" l_output2=""
...
configuration and should have a value of: \"$l_kpvalue\""
 ...
 echo -e "\n- Audit Result:\n ** PASS **\n$l_output\n"
 echo "IP FORWARDING:DISABLED" >> $RESULT_FILE
 log_message "IP forwarding is disabled."
 else
 echo -e "\n- Audit Result:\n ** FAIL **\n - Reason(s) for audit failure:\n$l_output2\n"
 [ -n "$l_output" ] && echo -e "\n- Correctly set:\n$l_output\n"
 echo "IP FORWARDING:ENABLED" >> $RESULT_FILE
 log_message "IP forwarding is not disabled."
 fi
