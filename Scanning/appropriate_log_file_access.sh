...
[ "$l_tst" != "failed" ] && l_agroup="(root|adm|$l_group)"
 ...
 echo "LOG FILE ACCESS:CONFIGURED" >> $RESULT_FILE
 log_message "All logfiles have appropriate access configured."
 else
 # print the reason why we are failing
 echo -e "\n- Audit Results:\n ** Fail **\n$l_output2"
 echo "LOG FILE ACCESS:NOT CONFIGURED" >> $RESULT_FILE
 log_message "Logfiles do not have appropriate access configured."
 fi
}
