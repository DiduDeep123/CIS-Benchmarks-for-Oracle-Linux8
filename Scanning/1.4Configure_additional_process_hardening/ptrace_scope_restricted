...
log_message "Checking if p_trace scope is restricted..."
 ...
 echo -e "\n- Audit Result:\n ** PASS **\n$l_output\n"
 echo "P_TRACE SCOPE:RESTRICTED" >> $RESULT_FILE
 log_message "P_trace scope is restricted."
 else
 echo -e "\n- Audit Result:\n ** FAIL **\n - Reason(s) for audit failure:\n$l_output2\n"
 [ -n "$l_output" ] && echo -e "\n- Correctly set:\n$l_output\n"
 echo "P_TRACE SCOPE:NOT RESTRICTED" >> $RESULT_FILE
 log_message "P_trace scope is not restricted."
 fi
