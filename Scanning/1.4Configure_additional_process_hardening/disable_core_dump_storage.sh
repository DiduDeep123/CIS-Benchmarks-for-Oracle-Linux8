...
log_message "Checking if core dump storage is disabled..."
...
check parameters
 ...
 echo -e "\n- Audit Result:\n ** PASS **\n$l_output\n"
 echo "CORE DUMP STORAGE:DISABLED" >> $RESULT_FILE
 log_message "Core dump storage is disabled."
 else
 echo -e "\n- Audit Result:\n ** FAIL **\n - Reason(s) for audit failure:\n$l_output2\n"
 echo "CORE DUMP STORAGE:NOT DISABLED" >> $RESULT_FILE
 log_message "Core dump storage is not disabled."
 [ -n "$l_output" ] && echo -e "\n- Correctly set:\n$l_output\n"
 fi
