...
if grep -q "RDS CHECK: FAILED" $RESULT_FILE; then

read -p "Do you want to remove rds module? (y/n)" answer
if [[ answer = [Yy] ]]; then
log_message "Starting remediation of rds module..."
...
log_message "Remediation of rds module complete."
