...
if grep -q "TIPC CHECK: FAILED" $RESULT_FILE; then

read -p "Do you want to remove tipc module? (y/n)" answer
if [[ answer = [Yy] ]]; then
log_message "Starting remediation of tipc module..."
...
log_message "Remediation of tipc module complete."
